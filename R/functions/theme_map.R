theme_map <- function(base_size = 12, base_family = font_choose_map, base_line_size = base_size/22, base_rect_size = base_size/22){
  ...
  theme(line = element_line(colour = "black", 
        ...
        axis.text.x = element_text(margin = margin(t = 0.8 * half_line/2), family = base_family, vjust = 1), 
        axis.text.x.top = element_text(margin = margin(b = 0.8 * half_line/2), vjust = 0), 
        axis.text.y = element_text(margin = margin(r = 0.8 * half_line/2), family = base_family, hjust = 1), 
